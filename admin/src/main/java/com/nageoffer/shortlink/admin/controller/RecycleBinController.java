...
public class RecycleBinController {
    ...
    public Result<Void> revoberRecycleBin(@RequestBody RecycleBinRecoverReqDTO requestParam) {
    ...
    public Result<Void> revoberRecycleBin(@RequestBody RecycleBinDeleteReqDTO requestParam) {
