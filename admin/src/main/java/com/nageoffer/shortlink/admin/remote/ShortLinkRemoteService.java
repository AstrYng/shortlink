...
import com.nageoffer.shortlink.admin.remote.dto.resp.ShortLinikGroupCountQueryRespDTO;
...
public interface ShortLinkRemoteService {
     ...
     * @return 查询分组短链接总量响应
     */
    default Result<List<ShortLinikGroupCountQueryRespDTO>> listGroupShortLinkCount(List<String> requestParam) {
        Map<String, Object> requestMap = new HashMap<>();
     ...
     * @return 网站标题
     */
    default Result<String> getTitleByUtl(@RequestParam("url") String url) {
     ...
     */
    default void removeRecycleBin(@RequestBody RecycleBinDeleteReqDTO requestParam) {
